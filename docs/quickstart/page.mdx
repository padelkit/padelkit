export const metadata = {
  title: "Quickstart",
  description: "Learn how to install and use PadelKit in minutes.",
}
...
<AddedIn version="1.1.0">
# You can easily undo a point in case of a mistake (added in 1.1.0)
match.history.undo_point()
</AddedIn>
...
<Version min="1.0.0" max="1.0.0">
*Note: In version 1.0.0, to undo a point you must rebuild the MatchScoreHistory without the last event.*
</Version>
...
<div className="not-prose mt-6 flex gap-3">
  <Button href="/court-geometry" arrow="right">
    <>Court Geometry</>
  </Button>
